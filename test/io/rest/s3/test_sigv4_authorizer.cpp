...
using cucascade::io::rest::s3::static_credentials_from;
...
class object_only_authorizer final : public cucascade::io::rest::request_authorizer {
 public:
...
{
  using cucascade::io::rest::s3::parse_list_objects_v2;
...
{
  auto const page = cucascade::io::rest::s3::parse_list_objects_v2(
...
{
  CHECK_THROWS_AS(cucascade::io::rest::s3::parse_list_objects_v2(
                    R"(</ListBucketResult><ListBucketResult><IsTruncated>false</IsTruncated>)"),
                  std::runtime_error);
}
