...
using cucascade::io::rest::s3::uri_encode;
...
std::string authorization_header(cucascade::io::rest::s3::sigv4_signed_request const& req)
{
...
std::string header_value(cucascade::io::rest::s3::sigv4_signed_request const& req,
